...
dataset_2_cl = cl.clustering_feature_space_agglomerative(dataset_pd,nb_clusters=ncl,normalize=False)
	#mean, maximum, minimum = cl.mean_distance_metrics(dataset_2_cl,nb_clusters)
#print("Cluster size: {} - Mean cluster size: {} - Largest: {} - Smallest: {}".format(cl_size,mean,maximum,minimum))

#DBSCAN
#dataset_2_cl, ncl = cl.clustering_feature_space_dbscan(dataset_pd,remove_coordinates=True)
